                    ...
                    <div class="error-content">
                        <div class="card mb-0">
                            <div class="card-body text-center pt-5">
                                <h2 class="error-text text-primary">Acceso Denegado</h1>
                                <h4 class="mt-4"><i class="fa fa-thumbs-down text-danger"></i> Usuario sin Permisos</h4>
                                <p>Tu usuario no tiene permisos para acceder a estas herramientas</p>
                                <form class="mt-5 mb-5">
                                    
                                    <div class="text-center mb-4 mt-4"><a href="index.php" class="btn btn-primary">Regresar a Inicio</a>
                                    </div>
                                </form>
                            </div>
                        </div>
